...
Required R scripts/files and readings for the workshop exercises will be posted to CANVAS and the workshop website <https://seascapeecologylab-workshops.github.io/BSC6926-B52_Fall2026/>.
...
#### **Teaching:** 
Each workshop session will include lectures and R programming exercises to introduce several topics in population and community modeling and analyses and provide context for the ecological fundamentals taught in PCB5423. The grade will be based on participation, one homework, and a final project (see below).\

#### **Grading:** 
The final grade will be composed of 3 assignments/tasks. These three assignments/tasks are: 1) Class participation (attendance and class exercises), 2) two in-class group assignments (“Homework Hackathons”), and 3) an in-class group project (“Project Hackathon”)\
...
**R homework exercises (Total 50 pts)** will count for 35% of your grade. After sections I (R programming) and II (Population Models), students will work in teams of three (randomly assigned) to solve a series of coding problems/prompts in class using class notes and recommended books/websites, except for AI platforms. This activity promotes learning R and becoming familiar with the coding side of ecological data analysis/modeling. Please submit homework answers as PDFs or Word documents in Markdown or Quarto format <https://quarto.org/docs/authoring/markdown-basics.html>; <https://quarto.org/docs/guide/>), along with the R files showing the code used to answer the questions.\  

**Group in-class project (Total 50 pts)** will count for 40% of your grade. As with the in-class homework hackathons, the class will be divided into six groups of three students, who will work together on a dataset and a set of questions provided by the instructors that encompass all material covered in previous workshops (i.e., a comprehensive assignment). Instructors will assign groups randomly. Groups will present their findings and submit a final summary report (3-5 pages) during the last scheduled workshop. Groups should submit a PDF copy of their report following Quarto format. \ 
...
#### **Make-up policy: **
I will provide make-up opportunities only when students present valid excuses (e.g., medical/family emergencies, major fieldwork trips, or conferences). Regardless of the reason, please contact me to identify alternative ways to complete course requirements, depending on the type of assignment missed and the severity of the missed assignments. Below is a guideline of potential make-up scenarios/methods (Subject to change):
